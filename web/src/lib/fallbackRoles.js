...
const FALLBACK_EMPLOYERS = {
  data: [
    ...
    { name: 'Garanti BBVA Teknoloji', url: 'https://www.garantibbvateknoloji.com.tr/bizde-kariyer' },
  ...
  ux: [
    ...
    { name: 'Getir', url: 'https://www.linkedin.com/company/getir/jobs/' },
    { name: 'Trendyol', url: 'https://careers.trendyol.com/' },
    { name: 'Defacto', url: 'https://kurumsal.defacto.com/ise-alim-ve-staj/' },
  ...
  biotech: [
    ...
    { name: 'TÜBİTAK', url: 'https://kariyer.tubitak.gov.tr/' },
  ],
  default: [
    { name: 'Turkcell', url: 'https://kariyerim.turkcell.com.tr/' },
