...
const PROFILE = {
  quant: {
    ...
    focus: [
      ...
      'Optimizasyon',
      'Simülasyon',
      'SQL ve veri sorgulama',
    ],
    joy: [
      'Veriyle örüntü bulmak',
      'Model performansı kıyaslamak',
      'Karmaşık problemi parçalamak',
      'Rapor hazırlamak',
      'Deney tasarlamak',
      'Grafik ve dashboard hazırlamak',
      'Hipotez test etmek',
  ...
  social: {
    ...
    focus: [
      ...
      'Davranış analizi',
      'Toplumsal etki',
      'İletişim ve içerik tasarımı',
      'Etik değerlendirme',
      'Topluluk yönetimi',
      'Nitel araştırma yöntemleri',
      'Kültürel analiz',
      'Hikaye anlatıcılığı',
      'Anket ve mülakat tasarımı',
    ],
    joy: [
      'İnsanla görüşme yapmak',
      'Nitel veri yorumlamak',
      'Empati haritası çıkarmak',
      'Anlatı oluşturmak',
      'Topluluklarda kolaylaştırıcılık yapmak',
  ...
  life: {
    ...
    focus: [
      'Sağlık verisi',
      'Laboratuvar çıktıları',
      'Biyoenformatik',
      'Bilimsel araştırma',
      'Klinik süreçler',
      'Genetik ve omik veri',
      'Deney tasarımı',
      'Regülasyon ve etik',
      'Sağlık ürünleri',
      'Biyostatistik',
    ...
    joy: [
      'Deney sonucu yorumlamak',
      'Bilimsel makale incelemek',
      'Veriyle hipotez test etmek',
      'Araştırma planlamak',
      'Laboratuvar notlarını sistematik tutmak',
      'Sağlık problemlerine teknoloji çözümü düşünmek',
  ...
  business: {
    ...
    joy: [
      'İş problemi tanımlamak',
      'Önceliklendirme yapmak',
      'Süreç akışı çıkarmak',
      'Veriyle karar savunmak',
      'Sunum ve hikayeleştirme yapmak',
  ...
  educationArts: {
    ...
    focus: [
      ...
      'Atölye ve müfredat tasarımı',
      'Yaratıcı kod / etkileşim',
    ],
    joy: [
      'Karmaşık konuyu sade anlatmak',
      'Görsel/dijital içerik hazırlamak',
      'Yaratıcı fikir geliştirmek',
      'Öğrenme deneyimi tasarlamak',
      'Sunum veya sahne anlatımı yapmak',
